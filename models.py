...
class GCNN(nn.Module):
    def __init__(self, n_output=1, num_features_pro= 20, output_dim=128, dropout=0.2):
...
# open the file in the write mode
        ...
        # writer.writerow(pro1_x)

        # # close the file
        # f.close()
        # exit()
        print(pro1_edge_index)
        print(len(pro1_edge_index))
        print(pro1_batch)
        print(len(pro1_batch))
